...
df = pd.read_csv("D:/FISHY WEB/web_phishing/web_phishing/web_phishing/new_extracted.csv")
    ...
    def StatsReport(self):
        ...
        'at/.ua|usa/.cc|baltazarpresentes/.com/.br|pe/.hu|esy/.es|hol/.es|sweddy/.com|myjino/.ru|96/.lt|ow/.ly', self.url)
            ...
            ip_match = re.search('146/.112/.61/.108|213/.174/.157/.151|121/.50/.168/.88|192/.185/.217/.116|78/.46/.211/.158|181/.174/.165/.13|46/.242/.145/.103|121/.50/.168/.40|83/.125/.22/.219|46/.242/.145/.98|'
                                ...
                                '216/.38/.62/.18|104/.130/.124/.96|47/.89/.58/.141|78/.46/.211/.158|54/.86/.225/.156|54/.82/.156/.19|37/.157/.192/.102|204/.11/.56/.48|110/.34/.231/.42', self.ip_address)
            if url_match:
                return -1
            elif self.ip_match:
                return -1
...
def check_url_phishy(url: str) -> int:
    obj = FeatureExtraction(url)
    dk = obj.getFeaturesList()
    df3 = pd.DataFrame([dk], columns=columns)
    result = knn.predict(df3)
    b = result[0]
    print("RESULTANSH", b)
    if b!=-1:
        return 0
